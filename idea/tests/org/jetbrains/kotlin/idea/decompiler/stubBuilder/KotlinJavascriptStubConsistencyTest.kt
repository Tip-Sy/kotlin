...
public class KotlinJavascriptStubConsistencyTest : JetLightCodeInsightFixtureTestCase() {
    ...
    public fun testConsistencyForKotlinPackage() {
        ...
        val decompiledText = buildDecompiledTextFromJsMetadata(kotlinPackageFile).text
        val clsStub = KotlinJavascriptStubBuilder().buildFileStub(FileContentImpl.createByFile(kotlinPackageFile))!!
